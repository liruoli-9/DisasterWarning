       ...
       <!-- 总体布局-start -->
        <div v-else class="koi-body">
          <!-- 第一部分-头部-start -->
            <div class="header">
              <!-- 首页 -->
              <a class="homePage font-bold colorDeepskyblue" :style="{'font-size': Math.round(this.screenWidth/100) + 'px'}" href="https://gitee.com/BigCatHome/koi-screen" target="_self"></a>
              <!-- 时间 -->
              ...
              <!-- 标题 -->
              <span class="title font-bold colorText" :style="{'font-size': Math.round(this.screenWidth/100) + 'px'}">灾害预测可视化大屏</span>
              <!-- 装饰8 -->
        ...
        <div class="layoutHome">
          <el-row>
            <el-col :span="6">
              <div :style="{ height: kHOne + 'px'}" :key="key">
